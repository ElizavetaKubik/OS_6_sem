...
void TestHTAPI()
{
	...
	try
	{
		...
		HT::HashTable test_hash_table2(20, 30, 20, 20, Utilities::GetModulePath() + "map2.txt");
		InsertTestData(test_hash_table2);
