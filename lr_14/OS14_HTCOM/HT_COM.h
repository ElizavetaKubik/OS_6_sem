...
public:
	...
	STDMETHOD(Create(HT::HashTableData** result, int inCapacity, int inSecSnapshotInterval, int inMaxKeyLength, int inMaxValueLength, string inFileName, LPCWSTR HTUsersGroup));
	STDMETHOD(CreateFromFile(HT::HashTableData** result, string inFileName));

	STDMETHOD(Open(HT::HashTableData** result, string inFileName));
	STDMETHOD(Open(HT::HashTableData** result, string inFileName, LPCWSTR userName, LPCWSTR password));
