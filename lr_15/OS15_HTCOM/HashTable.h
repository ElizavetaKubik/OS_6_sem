...
namespace HT   
{
	...
	HT_API HashTableData* OpenHT_FromFile(string inFileName, LPCWSTR HTUsersGroup);

	HT_API HashTableData* CreateHT_FromFile(const char* inFileName, LPCWSTR HTUsersGroup);
